...
> Перенесено 2026-09-04 (владелец → ENGINEER) из `Leonxlnx/taste-skill` (GitHub) — импортирован флагманский `design-taste-frontend` (v2, текущий дефолт источника). Репозиторий содержит ~11 сопутствующих специализаций (brandkit, brutalist-skill, minimalist-skill, redesign-skill, soft-skill, stitch-skill, imagegen-frontend-mobile/web, v1-версия и др.) — не перенесены по отдельности, доступны при появлении дизайн-агента.
